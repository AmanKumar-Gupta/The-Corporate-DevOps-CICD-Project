...
function Layout({ children }) {
  ...
  return (
    <div className="app-layout">
      ...
      <AnimatedBanner message="Welcome to My Project 🚀" />
      <div className="app-body">
        <aside className="sidebar slide-in-left">
          <h3>Connect</h3>
          <ul className="social-links">
            <li><a className="sidebar-btn" href="https://www.linkedin.com/in/amankg/" target="_blank" rel="noopener noreferrer">LinkedIn</a></li>
            <li><a className="sidebar-btn" href="https://www.youtube.com/@devopsshack" target="_blank" rel="noopener noreferrer">YouTube</a></li>
            <li><a className="sidebar-btn" href="https://www.instagram.com/amanguptaji1" target="_blank" rel="noopener noreferrer">Instagram</a></li>
          </ul>
        </aside>
      ...
      <footer className="app-footer">
        <p>&copy; {new Date().getFullYear()} DevOps Project. All rights reserved.</p>
      </footer>
